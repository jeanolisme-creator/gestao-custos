-- Atualizar políticas RLS para permitir acesso a todos os usuários autenticados
...
CREATE POLICY "All authenticated users can view school records"
ON public.school_records
FOR SELECT
TO authenticated
USING (true);

CREATE POLICY "All authenticated users can create school records"
ON public.school_records
FOR INSERT
TO authenticated
WITH CHECK (auth.uid() = user_id);

CREATE POLICY "All authenticated users can update school records"
ON public.school_records
FOR UPDATE
TO authenticated
USING (true)
...
CREATE POLICY "All authenticated users can delete school records"
ON public.school_records
FOR DELETE
TO authenticated
USING (true);
...
CREATE POLICY "All authenticated users can view energy records"
ON public.energy_records
FOR SELECT
TO authenticated
USING (true);

CREATE POLICY "All authenticated users can create energy records"
ON public.energy_records
FOR INSERT
TO authenticated
WITH CHECK (auth.uid() = user_id);

CREATE POLICY "All authenticated users can update energy records"
ON public.energy_records
FOR UPDATE
TO authenticated
USING (true)
...
CREATE POLICY "All authenticated users can delete energy records"
ON public.energy_records
FOR DELETE
TO authenticated
USING (true);
...
CREATE POLICY "All authenticated users can view mobile records"
ON public.mobile_records
FOR SELECT
TO authenticated
USING (true);

CREATE POLICY "All authenticated users can create mobile records"
ON public.mobile_records
FOR INSERT
TO authenticated
WITH CHECK (auth.uid() = user_id);

CREATE POLICY "All authenticated users can update mobile records"
ON public.mobile_records
FOR UPDATE
TO authenticated
USING (true)
...
CREATE POLICY "All authenticated users can delete mobile records"
ON public.mobile_records
FOR DELETE
TO authenticated
USING (true);
...
CREATE POLICY "All authenticated users can view fixed line records"
ON public.fixed_line_records
FOR SELECT
TO authenticated
USING (true);

CREATE POLICY "All authenticated users can create fixed line records"
ON public.fixed_line_records
FOR INSERT
TO authenticated
WITH CHECK (auth.uid() = user_id);

CREATE POLICY "All authenticated users can update fixed line records"
ON public.fixed_line_records
FOR UPDATE
TO authenticated
USING (true)
...
CREATE POLICY "All authenticated users can delete fixed line records"
ON public.fixed_line_records
FOR DELETE
TO authenticated
USING (true);
...
CREATE POLICY "All authenticated users can view school demand records"
ON public.school_demand_records
FOR SELECT
TO authenticated
USING (true);

CREATE POLICY "All authenticated users can create school demand records"
ON public.school_demand_records
FOR INSERT
TO authenticated
WITH CHECK (auth.uid() = user_id);

CREATE POLICY "All authenticated users can update school demand records"
ON public.school_demand_records
FOR UPDATE
TO authenticated
USING (true)
...
CREATE POLICY "All authenticated users can delete school demand records"
ON public.school_demand_records
FOR DELETE
TO authenticated
USING (true);
...
CREATE POLICY "All authenticated users can create schools"
ON public.schools
FOR INSERT
TO authenticated
WITH CHECK (auth.uid() = user_id);

CREATE POLICY "All authenticated users can update schools"
ON public.schools
FOR UPDATE
TO authenticated
USING (true)
...
CREATE POLICY "All authenticated users can delete schools"
ON public.schools
FOR DELETE
TO authenticated
USING (true);
